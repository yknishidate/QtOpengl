...
QT_MOC_LITERAL(1, 9, 12), // "modelDeleted"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 2), // "id"
QT_MOC_LITERAL(4, 26, 7), // "addMesh"
QT_MOC_LITERAL(5, 34, 11), // "std::string"
QT_MOC_LITERAL(6, 46, 4), // "name"
QT_MOC_LITERAL(7, 51, 8), // "addModel"
QT_MOC_LITERAL(8, 60, 6) // "Model*"

    },
    "TreeView\0modelDeleted\0\0id\0addMesh\0"
    "std::string\0name\0addModel\0Model*"
};
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modelDeleted((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->addMesh((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 2: _t->addModel((*reinterpret_cast< Model*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TreeView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeView::modelDeleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TreeView::modelDeleted(int _t1)
{
