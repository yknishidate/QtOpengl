...
#include <memory>
#include "../../QtOpengl/renderwindow.h"
...
QT_MOC_LITERAL(1, 13, 36), // "on_renderPassBox_currentIndex..."
QT_MOC_LITERAL(2, 50, 0), // ""
QT_MOC_LITERAL(3, 51, 5), // "index"
QT_MOC_LITERAL(4, 57, 21) // "on_saveButton_clicked"

    },
    "RenderWindow\0on_renderPassBox_currentIndexChanged\0"
    "\0index\0on_saveButton_clicked"
};
...
void RenderWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_renderPassBox_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
